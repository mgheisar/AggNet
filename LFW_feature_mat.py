...
feat = sio.loadmat('/home/mgheisar/Documents/secure-nn/TernaryEmbedding/experiments/Build_datasets/features.mat')
feat = feat['features']
pca = PCA(n_components=1024)
pca.fit(feat.T)
features = pca.transform(feat.T)
features = features.T
